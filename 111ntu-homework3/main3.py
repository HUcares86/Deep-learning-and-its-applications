...
TRAIN_CSV = '/home/shelley/Desktop/hucares/DL_final2/train.csv'
# TRAIN_CSV = '/home/shelley/Desktop/hucares/DL_final2/total_data.csv'
# TRAIN_CSV = '/home/shelley/Desktop/hucares/DL_final2/2022_5_1_data.csv'
...
# EmbargoCV
    ...
    for split, train_test_split in enumerate(train_test_zip):
        ...
        aaaa = list(  model.predict(df_proc.loc[test_split_index, features])        )
        bbbb = list(   df_proc.loc[test_split_index, f'Target_{asset_id}'].values    )
        ...
        # print(  len(bbbb))
        # plt.plot(aaaa ,'b')
        # plt.savefig(f'ID={asset_id}_split_{split+1}_out_of_{n_fold}_3_month_pred.png')  
        # plt.clf()
        # plt.plot(bbbb, 'r')
        # plt.savefig(f'ID={asset_id}_split_{split+1}_out_of_{n_fold}_3_month_valid.png')  
        # plt.clf()
    
    
    plot_importance(np.array(importances),features, PLOT_TOP_N = 20, figsize=(10, 5))
    plt.savefig(f'ID={asset_id}_split_{split+1}_out_of_{n_fold}_3_month.png')  
    plt.clf()
...
for asset_id, asset_name in zip(df_asset_details['Asset_ID'], df_asset_details['Asset_Name']):
    ...
    # print(len(oof_valid))
    # plt.plot(oof_pred,'b')
    # plt.savefig(f'ID={asset_id}_3_month_pred.png')  
    # plt.clf()
    # plt.plot(oof_valid, 'r')
    # plt.savefig(f'ID={asset_id}_3_month_valid.png')  
    # plt.clf()
